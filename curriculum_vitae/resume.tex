...
\name{Etcheverlepo}{Adrien}
% \position{HPC Software developer{\enskip\cdotp\enskip}Security Expert}
\position{HPC Software Engineer}
\address{7 av Général de Gaulle, Pau}

\mobile{07 49 08 95 37}
\email{adrien.etcheverlepo@gmail.com}
%\dateofbirth{January 1st, 1970}
% \homepage{themagicalmammal.vercel.app} 
% \github{themagicalmammal}
\linkedin{linkedin.com/in/adrien-etcheverlepo}
% \gitlab{gitlab-id}
